            ...
            <div className="space-y-4">
              ...
              <Controller
                ...
                render={({ field }) => {
                  ...
                  const tagObjects = value.map((text, index) => ({ id: index, text }));
                  ...
                  return (
                    <TagInput
                      ...
                      className="w-full"
                      styleClasses={{
                        input: 'h-10 rounded-md px-3 py-2 text-sm outline-none bg-transparent basis-full',
                        inlineTagsContainer:
                          'flex flex-wrap gap-2 p-2 bg-background border border-input rounded-md',
                        tag: {
                          body: 'bg-muted px-2 py-1 rounded text-sm flex items-center gap-1 flex-none',
